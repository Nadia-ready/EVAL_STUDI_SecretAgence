...
final class Version20211103000014 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create mission_contact table';
    }
    ...
    {
        $table = $schema->createTable('mission_contact');
    ...
    {
        $schema->dropTable('mission_contact');
    }
}
